...
def send_data_to_google_sheet(temperature, humidity): #removed SR and P
    ...
    while True:
        ...
        if len(data) == 2: #changed 4 to 2
           ...
           # power = data[3]
            ...
            send_data_to_google_sheet(temperature, humidity) #removed SR and P
